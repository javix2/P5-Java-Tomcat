...
public class miServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Serie Fibonacci</h1>");
            out.println(serieFibonacci(Integer.parseInt(request.getParameter("valor"))));
            out.println("</body>");
            out.println("</html>");
        }
    }
